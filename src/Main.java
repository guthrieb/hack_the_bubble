        ...
        while (isRunning) {
            try {
                ...
                for (int i = 0; i < objects.size(); i++) {
                    ...
                    at.translate(objects.get(i).getX(), objects.get(i).getY());
                    g2d.setColor(Color.BLACK);
                    Spawn s = objects.get(i);


                    g2d.fill(new Rectangle2D.Double(s.getX(), s.getY(), s
                            .getRadius() * 0.5, s.getRadius() * 0.5));
                    g2d.rotate(s.rotation.angle());
